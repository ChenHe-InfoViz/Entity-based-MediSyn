function drawNodeView(root, i, historyArray){
...
function drawHisView(rootNode, i, historyArray){
    ...
    // }
     ...
     var nodeView = new drawNodeView(rootNode, i, historyArray)
...
function drawGrid(){
    ...
    gridEnter.append("label").text(function(d){ return d.noteTime })
